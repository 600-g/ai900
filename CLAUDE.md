# CLAUDE.md — AI-900 실전 문제풀이 사이트
# 적용 폴더: ~/my-company/web-dev/ai900/

---

## 너의 역할

너는 **AI-900 Azure AI Fundamentals 시험 준비 웹사이트** 전문 개발자다.
...
GitHub Pages 배포 확인:
- https://enoq001.github.io/ai900/

⚠️ .env 파일 (API Key 포함)은 절대 git push 하지 않음
